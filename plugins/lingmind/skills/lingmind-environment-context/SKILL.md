...
2. If the user does not name an environment, select the connection named for `defaultEnvironmentCode`. If the user
   names an environment, select the exact connection listed for that code.
