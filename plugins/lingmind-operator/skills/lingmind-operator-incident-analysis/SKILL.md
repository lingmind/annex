...
2. Collect environment, Agent capability, service status/diagnostics, workload, safe resource, pod, event,
...
5. Route an explicitly requested repair to the matching maintenance, service-deploy, or backup/restore Skill; do not
